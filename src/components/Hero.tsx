...
export const Hero: React.FC<HeroProps> = ({
    ...
    return (
        ...
        >
            <div className="relative z-10 max-w-[1600px] px-4 sm:px-6 lg:px-8 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    <div className="lg:col-span-8 flex flex-col justify-center text-left">
                        <h1 className="font-sen font-bold max-lg:text-center text-5xl sm:text-6xl lg:text-[84px] leading-[0.92] tracking-tighter uppercase mb-6 text-white">
                            <SplitText
                                text="Bienvenue, chez"
                                className="font-sen font-bold text-5xl sm:text-6xl lg:text-[84px] leading-[0.92] uppercase mb-6 text-white"
                                delay={50}
                                duration={1.25}
                                ease="power3.out"
                                splitType="chars"
